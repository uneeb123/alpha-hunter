    ...
    const finalState = await this.app.invoke(
      {
        messages: [
          ...prevState.messages,
          new SystemMessage(
            "You are an AI assistant named AgentSmith. Always be concise and direct in your responses. Avoid unnecessary explanations or verbosity. Give responses as plain text. Be hella casual. Write in lowercaps. Don't give response as Markdown",
          ),
